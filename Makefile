...
top_srcdir = .
VPATH = .
pkgdatadir = $(datadir)/dvd_a_divx
pkglibdir = $(libdir)/dvd_a_divx
pkgincludedir = $(includedir)/dvd_a_divx
top_builddir = .
...
ACLOCAL = ${SHELL} /root/cesar/dvd_a_divx/admin/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /root/cesar/dvd_a_divx/admin/missing --run tar
AR = ar
ARTSCCONFIG = /opt/kde3/bin/artsc-config
AUTOCONF = $(SHELL) $(top_srcdir)/admin/cvs.sh configure || touch configure
AUTODIRS = 
AUTOHEADER = ${SHELL} /root/cesar/dvd_a_divx/admin/missing --run autoheader
AUTOMAKE = ${SHELL} /root/cesar/dvd_a_divx/admin/missing --run automake-1.8
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/cesar/dvd_a_divx/admin/missing --run makeinfo
...
infodir = ${prefix}/info
install_sh = /root/cesar/dvd_a_divx/admin/install-sh
...
#>+ 2
KDE_DIST=stamp-h.in subdirs Makefile.in dvd_a_divx.kdevses dvd_a_divx.kdevelop dvd_a_divx.kdevelop.pcs configure.files config.h.in configure.in Makefile.cvs TRANSLATIONS aclocal.m4 Doxyfile configure Makefile.am acinclude.m4 
